...
try {
    ...
    // so we can display their real names and emails based on our new schema.
    $stmt = $pdo->query("
...
<head>
    ...
    <style>
        ...
        .sidebar { width: 260px; padding: 20px; border-right: 1px solid var(--glass-border); display: flex; flex-direction: column; }
        .main-content { flex: 1; padding: 40px; } 
        
        .nav-link { display: block; padding: 12px; margin-bottom: 5px; border-radius: 8px; color: var(--text-main); text-decoration: none; font-weight: 500; }
        ...
        /* Our pop-up modal styles for editing a student */
...
<body>
    <div class="layout">
        <aside class="sidebar">
            ...
            <nav style="flex: 1;">
                ...
                <a href="students.php" class="nav-link active">Student Management</a>
                    ...
                    <tbody>
                        <?php foreach ($students as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-outline edit-btn" style="padding: 5px 10px; font-size: 0.8rem;" 
    ...
    <script>
        // We use this function to populate the modal with the specific student's data when the Admin clicks Edit
