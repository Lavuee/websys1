    ...
    <section class="hero-section">
        <div class="container">
            ...
            <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
                <a href="apply.php" class="btn btn-primary"><i class="bi bi-pencil-square"></i> Start Application</a>
                <a href="actions/track_status.php" class="btn btn-outline"><i class="bi bi-search"></i> Track Status</a>
    ...
    <section style="padding: 100px 0; background: var(--panel-bg); border-top: 1px solid var(--panel-border); border-bottom: 1px solid var(--panel-border);">
        <div class="container">
            ...
            <div class="text-center mt-4">
                <a href="apply.php" class="btn btn-primary">Begin Registration Now <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>
    </section>
