...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2026 at 03:53 PM
...
ALTER TABLE `class_schedules`
  ...
  ADD CONSTRAINT `class_schedules_ibfk_3` FOREIGN KEY (`faculty_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
...
ALTER TABLE `grades`
  ...
  ADD CONSTRAINT `grades_ibfk_3` FOREIGN KEY (`faculty_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;
...
ALTER TABLE `sections`
  ...
  ADD CONSTRAINT `sections_ibfk_2` FOREIGN KEY (`adviser_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;
