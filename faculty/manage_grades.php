...
try {
    ...
    // Check if a specific subject was clicked from the dashboard, otherwise show all
    $filter_subject_id = $_GET['subject_id'] ?? null;
    ...
    <div class="layout">
        ...
        <main class="main-content">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 15px;">
                ...
                <?php if ($filter_subject_id): ?>
                    <a href="manage_grades.php" class="btn btn-outline">Show All Classes</a>
                <?php endif; ?>
            </div>
