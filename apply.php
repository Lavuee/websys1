    ...
    <div style="max-width: 700px; width: 100%;">
        ...
        <form action="actions/submit_application.php" method="POST">
            ...
            <div class="glass-panel form-section">
                ...
                <div class="form-grid">
                    <div class="form-group"><label>Email Address *</label><input type="email" name="student_email" required></div>
                    <div class="form-group"><label>Contact Number</label><input type="text" name="contact_number"></div>
                    <div class="form-group full-width"><label>Address</label><textarea name="address" rows="2"></textarea></div>
                    <div class="form-group"><label>Guardian / Parent Name</label><input type="text" name="guardian_name"></div>
                    <div class="form-group"><label>Guardian Contact Number</label><input type="text" name="guardian_contact"></div>
                </div>
            </div>
            ...
            <div class="glass-panel form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group"><label>Learner Reference Number (LRN)</label><input type="text" name="lrn"></div>
                    <div class="form-group"><label>Previous School</label><input type="text" name="previous_school"></div>
                </div>
            </div>

            <button type="submit" class="btn btn-primary" style="width: 100%; padding: 15px; font-size: 1.1rem; margin-top: 10px;">Submit Application</button>
        </form>
    </div>
